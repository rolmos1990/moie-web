      ...
      link: function (scope, element) {
        ...
        scope.magnify = function (evt) {
          ...
          if (!nWidth && !nHeight) {
            ...
            img.src = scope.imageSrc + '_400.jpg';
          } else {
            ...
            rx = Math.round(mx/el.imageWidth*2*nWidth - el.glassWidth/2)*-1;
            ry = Math.round(my/el.imageHeight*2*nHeight - el.glassHeight/2)*-1;
            bgp = rx + 'px ' + ry + 'px';
        ...
        scope.getContainerStyle = function () {
          return {
            ...
            height: (scope.imageHeight) ? scope.imageWidth*1.5 + 'px' : ''
          };
        };

        scope.getGlassStyle = function () {
          return {
            background: 'url(' + scope.imageSrc + '_800.jpg) no-repeat',
